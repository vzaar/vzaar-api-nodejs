  ...
  post: function(callback, data){
    ...
    req.on('response', function (res) {
      ...
      res.on('data', function (_data) {
        callback(res.statusCode, JSON.parse(_data));
      });
    });
  },
...
Core.inherit(GenerateThumbnail, Request, {
  post: function(callback, body){
    var _super = Request.prototype.post;
    _super.call(this, callback, { vzaar_api: { video: { thumb_time: body.time }}});
  }
});
...
Core.inherit(AddSubtitle, Request, {
  post: function(callback, body){
    var _super = Request.prototype.post;
    _super.call(this, callback, { vzaar_api: { subtitle: body }});
  }
});
