...
var ProcessVideo = function(connectionOptions, params) {
  this.connectionOptions = connectionOptions;
  this.connectionOptions.path = "/api/videos.json";
  this.connectionOptions.params = this.buildParams(params);
};

ProcessVideo.prototype = {
  execute: function(callback){
    var conn = new Connection(this.connectionOptions, callback);
    conn.post();
  },
